...
# the order of the functions is from left to right
# capitalize letters from all words in str
# name = name.title()

# chain the functions in order to remove whitespace and then capitalize all letters from all words in the name
